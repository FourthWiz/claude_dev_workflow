...
Run from project root:
  python3 -m pytest dev-workflow/scripts/tests/test_path_resolve_e2e.py -v
"""
...
SKILLS_GLOB = str(PROJECT_ROOT / "dev-workflow" / "skills" / "*" / "SKILL.md")
CLAUDE_MD = PROJECT_ROOT / "dev-workflow" / "CLAUDE.md"
INSTALL_SH = PROJECT_ROOT / "dev-workflow" / "install.sh"
RESOLVER = PROJECT_ROOT / "dev-workflow" / "scripts" / "path_resolve.py"
...
EXPLICIT_FORM_B_C_FILES = [
    str(PROJECT_ROOT / "dev-workflow" / "skills" / "plan" / "SKILL.md"),
    str(PROJECT_ROOT / "dev-workflow" / "skills" / "gate" / "SKILL.md"),
    str(PROJECT_ROOT / "dev-workflow" / "skills" / "architect" / "SKILL.md"),
]
...
sys.path.insert(0, str(PROJECT_ROOT / "dev-workflow" / "scripts"))
