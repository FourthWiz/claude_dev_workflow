...
| Generated adapter coverage | Portable core has 29 migrated skill contracts. | Claude adapter has per-skill `SKILL.md` files and install routing for the 29 migrated skills. | Codex adapter has generated/scaffolded per-skill README docs for all 29 migrated skills. | Generated active Claude skill files and active Codex runtime command files are not implemented. | `quoin/core/skills/`, `quoin/adapters/claude/skills/`, `quoin/adapters/codex/skills/`, `quoin/core/scripts/validate_adapter_drift.py`, `quoin/adapters/codex/generate_codex_assets.py` |
...
All 29 migrated skills have portable contracts, Claude adapter skill files, and
...
| `checkpoint` | `quoin/core/skills/checkpoint.md` | `quoin/adapters/claude/skills/checkpoint/SKILL.md` | `quoin/adapters/codex/skills/checkpoint/README.md` | `skills.json`, adapter drift validator, Codex generator/readiness tests |
| `cleanup` | `quoin/core/skills/cleanup.md` | `quoin/adapters/claude/skills/cleanup/SKILL.md` | `quoin/adapters/codex/skills/cleanup/README.md` | `skills.json`, adapter drift validator, Codex generator/readiness tests |
| `continue_work` | `quoin/core/skills/continue_work.md` | `quoin/adapters/claude/skills/continue_work/SKILL.md` | `quoin/adapters/codex/skills/continue_work/README.md` | `skills.json`, adapter drift validator, Codex generator/readiness tests |
| `next_steps` | `quoin/core/skills/next_steps.md` | `quoin/adapters/claude/skills/next_steps/SKILL.md` | `quoin/adapters/codex/skills/next_steps/README.md` | `skills.json`, adapter drift validator, Codex generator/readiness tests |
| `pr` | `quoin/core/skills/pr.md` | `quoin/adapters/claude/skills/pr/SKILL.md` | `quoin/adapters/codex/skills/pr/README.md` | `skills.json`, adapter drift validator, Codex generator/readiness tests |
| `sleep` | `quoin/core/skills/sleep.md` | `quoin/adapters/claude/skills/sleep/SKILL.md` | `quoin/adapters/codex/skills/sleep/README.md` | `skills.json`, adapter drift validator, Codex generator/readiness tests |
| `status` | `quoin/core/skills/status.md` | `quoin/adapters/claude/skills/status/SKILL.md` | `quoin/adapters/codex/skills/status/README.md` | `skills.json`, adapter drift validator, Codex generator/readiness tests |
