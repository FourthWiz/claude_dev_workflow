...
- `quoin/memory/clean-authored-content.md` (+ `__QUOIN_HOME__/memory/clean-authored-content.md` deployed copy — shared rule for keeping comments, commit messages, and PR descriptions free of planning-process vocabulary; added IVG-252 stage 1 2026-08-15)
