...
command file for `capture_insight` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/capture_insight.md`. Preserve Quoin artifact
