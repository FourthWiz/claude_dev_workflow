...
command file for `continue_work` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/continue_work.md`. Preserve Quoin artifact
