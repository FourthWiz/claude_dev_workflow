...
command file for `thorough_plan` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/thorough_plan.md`. Preserve Quoin artifact
