...
command file for `cost_snapshot` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/cost_snapshot.md`. Preserve Quoin artifact
