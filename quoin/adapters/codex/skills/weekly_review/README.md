...
command file for `weekly_review` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/weekly_review.md`. Preserve Quoin artifact
