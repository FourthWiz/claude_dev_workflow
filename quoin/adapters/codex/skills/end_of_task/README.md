...
command file for `end_of_task` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/end_of_task.md`. Preserve Quoin artifact
