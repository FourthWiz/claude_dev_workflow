...
- `quoin/core/skills/sleep.md`
- `quoin/core/workflow/skills.json`

## Codex invocation

Ask for this workflow phase in natural language. Codex does not get a generated
command file for `sleep` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/sleep.md`. Preserve Quoin artifact
