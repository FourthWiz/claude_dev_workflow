...
command file for `cleanup` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/cleanup.md`. Preserve Quoin artifact
