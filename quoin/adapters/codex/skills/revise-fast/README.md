...
command file for `revise-fast` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/revise-fast.md`. Preserve Quoin artifact
