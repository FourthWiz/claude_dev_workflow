...
command file for `start_of_day` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/start_of_day.md`. Preserve Quoin artifact
