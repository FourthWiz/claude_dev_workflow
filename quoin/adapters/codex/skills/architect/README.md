...
command file for `architect` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/architect.md`. Preserve Quoin artifact
