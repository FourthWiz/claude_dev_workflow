...
command file for `init_workflow` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/init_workflow.md`. Preserve Quoin artifact
