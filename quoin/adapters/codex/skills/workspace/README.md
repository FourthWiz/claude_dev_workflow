...
- `quoin/core/skills/workspace.md`
- `quoin/core/workflow/skills.json`

## Codex invocation

Ask for this workflow phase in natural language. Codex does not get a generated
command file for `workspace` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/workspace.md`. Preserve Quoin artifact
