# security_review Codex Adapter

Generated/scaffolded from portable Quoin metadata.

Portable source:

- `quoin/core/skills/security_review.md`
- `quoin/core/workflow/skills.json`

## Codex invocation

Ask for this workflow phase in natural language. Codex does not get a generated
command file for `security_review` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/security_review.md`. Preserve Quoin artifact
