...
command file for `discover` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/discover.md`. Preserve Quoin artifact
