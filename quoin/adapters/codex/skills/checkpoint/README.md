...
command file for `checkpoint` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/checkpoint.md`. Preserve Quoin artifact
