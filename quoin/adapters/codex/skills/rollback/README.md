...
command file for `rollback` in this phase.

## Portable workflow contract

Follow the runtime-neutral contract in `quoin/core/skills/rollback.md`. Preserve Quoin artifact
