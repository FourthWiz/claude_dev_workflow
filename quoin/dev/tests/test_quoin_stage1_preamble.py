...
The 14 cheap-tier SKILL.md files carry a `## §0 Model dispatch ...` block as
...
MIGRATED_TO_ADAPTER = {"capture_insight", "triage", "start_of_day", "plan", "critic", "revise", "revise-fast", "gate", "implement", "rollback", "end_of_task", "run", "end_of_day", "weekly_review", "cost_snapshot", "expand"}
...
# 14 cheap-tier skills — must carry §0.
CHEAP_TIER_SKILLS = [
    "gate",
    "end_of_day",
    "start_of_day",
