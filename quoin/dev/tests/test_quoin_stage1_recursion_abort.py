...
MIGRATED_TO_ADAPTER = {"capture_insight", "triage", "start_of_day", "plan", "critic", "revise", "revise-fast", "gate", "implement", "rollback", "end_of_task", "end_of_day", "weekly_review", "cost_snapshot"}
