...
SKILL_FILES = [
    ...
    # Phase 19 migration: expand's authoritative SKILL.md lives in the Claude adapter path.
    ADAPTER_SKILLS_DIR / "expand" / "SKILL.md",
    ...
    ADAPTER_SKILLS_DIR / "implement" / "SKILL.md",
