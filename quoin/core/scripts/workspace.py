#!/usr/bin/env python3
"""Portable core implementation of feature-workspace create/teardown/status (IVG-158).
...
repo. This module owns the ``create`` subcommand (S-01), the ``teardown``
subcommand (S-03), and the read-only ``status``/``list`` subcommand (S-05)
— no takeover, no full liveness. See architecture.md D-01..D-09.
